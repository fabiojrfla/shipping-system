...
describe 'Administrador vê Ordens de Serviço' do
  it 'com sucesso' do
    ...
    first_so = ServiceOrder.create!(quote: first_quote)
    second_so = ServiceOrder.create!(quote: second_quote)
    ...
    expect(page).not_to have_css 'section#service-orders-accepted'
