class ShippingDeadline < ApplicationRecord
  belongs_to :shipping_company

  validates :start_distance, :end_distance, :deadline, presence: true
  ...
  def range_validator(shipping_company, start_range, end_range, attr_value)
    ...
    shipping_company.shipping_deadlines.pluck(start_range, end_range).detect do |s, e|
